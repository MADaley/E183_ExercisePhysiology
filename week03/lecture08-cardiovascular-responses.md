---
layout: lecture
title: "Lecture 8: Cardiovascular Responses to Exercise"
week: 3
lecture: 8
week_title: "Week 3: Control of Ventilation, Ventilation-Perfusion Matching, Cardiovascular Responses"
week_url: /week03/
total_slides: 39
...
![Title slide for "Cardiovascular responses to exercise" by Dr. Monica A. Daley, Professor, Ecology and Evolutionary Biology, University of California, Irvine. Background collage shows diverse animals and humans exercising: a cyclist, water polo ball, speed skater, sea turtle, horse, parrot, fish, and runners.](images/lec08/slide-001.png)

- This lecture covers the cardiovascular responses to exercise, including O<sub>2</sub>-hemoglobin binding, myoglobin function, the graphical Fick principle for comparing O<sub>2</sub> delivery across species, and the specific cardiovascular adjustments (heart rate, stroke volume, blood flow redistribution) during exercise.
- Topics bridge from the ventilatory system (covered in Lecture 6) to the circulatory system's role in O<sub>2</sub> delivery to the tissues.

---

## Slide 2

![Text slide titled "Cardiovascular responses to exercise" listing the overview (oxygen supply cascade from alveoli to mitochondria; cardiovascular response to exercise; comparative cardiorespiratory physiology) and seven learning objectives covering V/Q review, O2 transport mechanisms, factors limiting cardiovascular O2 transport, cardiac output increases, oxygen-dissociation curves, graphical Fick solution, and comparative cardiovascular function.](images/lec08/slide-002.png)
...
2. Describe the mechanisms that transport O<sub>2</sub> from the alveoli to the tissues.
3. Discuss factors that limit cardiovascular transport of O<sub>2</sub>.
4. Describe how **cardiac output** increases during exercise.
5. Describe how **oxygen-dissociation curves** influence O<sub>2</sub> transport in rest and exercise.
6. Use the **graphical solution to the Fick principle** to illustrate how blood O<sub>2</sub> concentration and cardiac output combine to increase O<sub>2</sub> delivery for exercise.
...
![Slide titled "Steps in the oxygen supply cascade" showing the four-step diagram with equations. Step 1: Pulmonary ventilation with the ventilatory Fick equation. Step 2: Alveolar gas exchange with diffusion equation. Step 3 (highlighted in green): Blood gas transport with the Fick principle for bulk blood flow: VO2 = Q̇·Bblood·(PaO2 − PvO2), the blood oxygen content form VO2 = Q̇(CaO2 − CvO2), and Q̇ = HR × SV. The arterial-venous gradient and blood oxygen content are labeled.](images/lec08/slide-003.png)
...
- Equivalently, in terms of blood O<sub>2</sub> content:
...
![Diagram showing the complete cardiorespiratory circuit with partial pressures labeled at each stage (inspired air PO2 159 mmHg, alveolar air PO2 104 mmHg, oxygenated blood PO2 95 mmHg, deoxygenated blood PO2 40 mmHg, tissue fluid PO2 40 mmHg). The right side lists factors in gas transport: alveolar ventilation, partial pressure gradients, diffusion conductance, ventilation-perfusion matching, and shunts.](images/lec08/slide-004.png)
...
![Graph titled "Ventilation/perfusion ratio V̇A/Q̇" identical to the V/Q graph from Lecture 6. X-axis: rib number from 5 (bottom) to 2 (top). Left y-axis: flow rate (L/min). Right y-axis: V̇A/Q̇ ratio. Three curves show blood flow (steep decline), ventilation (shallow decline), and the V/Q ratio (rising from below 1.0 at the base to above 3.0 at the apex). Labels indicate overperfused (shunt) at the base and underperfused (dead space ventilation) at the apex.](images/lec08/slide-005.png)
...
![Text slide titled "Cardiovascular responses to exercise" with overview and learning objectives identical to Slide 2: oxygen supply cascade from alveoli to mitochondria, cardiovascular response to exercise, comparative cardiorespiratory physiology, and seven learning objectives.](images/lec08/slide-006.png)
...
![Diagram of the complete cardiorespiratory circuit with partial pressures at each stage. Right side lists factors in gas transport with three items highlighted in blue: O2-hemoglobin curve, O2-myoglobin curve, and myoglobin store in muscle. These are the new topics for this portion of the lecture, added to the previously covered factors (alveolar ventilation, partial pressure gradients, diffusion conductance, ventilation-perfusion matching, shunts).](images/lec08/slide-007.png)
...
![Diagram of the cardiorespiratory circuit (same as Slide 7) with the factor "O2-hemoglobin curve" highlighted in blue on the right side. This identifies the specific topic being discussed next.](images/lec08/slide-008.png)

### Focus: O<sub>2</sub>-Hemoglobin Curve

- The **oxygen-hemoglobin dissociation curve** describes how hemoglobin binds and releases O<sub>2</sub> at different partial pressures.
- This curve is central to understanding how O<sub>2</sub> is loaded in the lungs and unloaded at the tissues — and how exercise conditions modify this process.

---

## Slide 9

![Slide titled "Oxygen-Hemoglobin Dissociation Curve." Left side shows the equation for percent saturation: %Sat = [O2]/O2 capacity × 100, with a note that O2 capacity is the maximum quantity of oxygen that will combine chemically with hemoglobin in a unit volume of blood (normally 1.34 mL O2 per g Hb, or 20 mL O2 per 100 mL of blood). Right side: a sigmoid curve with partial pressure of oxygen (mmHg) on the x-axis (0–120) and % saturation of Hb on the y-axis (0–100). The curve shows a steep rise between 20–60 mmHg and a plateau above 80 mmHg. A note states "On the y-axis we can have % Sat or [O2]."](images/lec08/slide-009.png)
...
![Graph titled "Oxygen-Hemoglobin Dissociation Curve." X-axis: PO2 (mmHg) from 0 to 100. Left y-axis: Hb saturation (%) from 0 to 100. Right y-axis: O2 concentration (mL per 100 mL) from 0 to 20. A solid sigmoid curve shows "O2 combined with Hb," a dashed line labeled "Total O2" runs slightly above it, and a nearly flat line near the x-axis shows "Dissolved O2." The vast majority of blood O2 is hemoglobin-bound; dissolved O2 is a very small fraction.](images/lec08/slide-010.png)
...
![Graph titled "Oxygen-Hemoglobin Dissociation Curve." X-axis: PO2 (mmHg) from 0 to 100. Left y-axis: percent oxyhemoglobin saturation (0–100%). Right y-axis: O2 content released (mL O2 per 100 mL blood, 0–20). The sigmoid curve is shown with annotations: "Arteries" at PO2 ≈ 100 mmHg (~100% saturation), "Veins (at rest)" at PO2 ≈ 40 mmHg (~75% saturation). A bracket labeled "Amount of O2 unloaded to tissues" spans the vertical drop between the arterial and venous saturation levels.](images/lec08/slide-011.png)
...
- During exercise, active muscles produce CO<sub>2</sub>, which lowers local blood pH — causing a rightward shift.
...
![Diagram of the cardiorespiratory circuit with partial pressures at each stage. Right side lists all factors in gas transport, with "O2-myoglobin curve" and "myoglobin store in muscle" highlighted in blue, indicating the next topic.](images/lec08/slide-014.png)
...
![Diagram of the cardiorespiratory circuit with partial pressures at each stage. Right side lists all factors in gas transport (alveolar ventilation, partial pressure gradients, diffusion conductance, ventilation-perfusion matching, shunts, O2-hemoglobin curve, O2-myoglobin curve, myoglobin store in muscle) — all now listed in standard black text, indicating all factors have been covered.](images/lec08/slide-016.png)
...
![Slide titled "Diversity & similitude in vertebrate cardiorespiratory systems" showing four vertebrate groups (fish, amphibian, reptile, mammal/bird) with circulatory diagrams. Fish: two-chambered heart, single circuit through gills. Amphibian: three-chambered heart with mixed blood in a shared ventricle. Reptile: partially divided ventricle with potential for shunting. Mammal/bird: fully divided four-chambered heart with separate pulmonary and systemic circuits.](images/lec08/slide-018.png)
...
![Slide titled "Graphical solution to the Fick principle for oxygen uptake." Same format as Slide 20, but showing a fish silhouette. The dissociation curve shows SMR (standard metabolic rate) and Exercise rectangles. The label uses "SMR" instead of "BMR" because ectotherms have a standard metabolic rate measured at a controlled temperature. Citation: Wang et al. 2019.](images/lec08/slide-021.png)
...
![Slide titled "Diversity & similitude in vertebrate cardiorespiratory systems." Four panels of bar graphs (from Wang et al. 2019) comparing cardiovascular parameters across diverse species grouped by color: fish/amphibians, reptiles, birds, and mammals. The parameters appear to include heart rate, stroke volume, cardiac output, and factorial changes during exercise. The bottom-right panel shows the factorial change in heart rate between rest and exercise, with birds showing the largest increases.](images/lec08/slide-023.png)
...
![Section divider slide with lavender background showing the title "Cardiovascular responses to exercise" in large black text. This marks the transition to the specific cardiovascular adjustments during exercise.](images/lec08/slide-026.png)
...
![Slide titled "Transition from rest to steady exercise to recovery." Three stacked time-series graphs with exercise time (min) on the x-axis (0–20). Top graph: cardiac output (L/min) rises sharply at exercise onset from ~5 to ~15 L/min, maintains a plateau during steady-state exercise, then gradually returns to rest during recovery. Middle graph: stroke volume (mL) rises modestly from ~80 to ~120 mL at exercise onset, then plateaus. Bottom graph: heart rate (beats/min) rises sharply from ~70 to ~160 at exercise onset, then gradually returns to rest during recovery. The recovery rate of heart rate is noted as an indicator of fitness.](images/lec08/slide-027.png)
...
![Slide titled "Effects of training" with a table showing typical resting and maximal exercise values for stroke volume (SV), heart rate (HR), and cardiac output (Q̇). Rest: untrained male HR 72, SV 70, Q̇ 5.00; untrained female HR 75, SV 60, Q̇ 4.50; trained male HR 50, SV 100, Q̇ 5.00; trained female HR 55, SV 80, Q̇ 4.40. Max exercise: untrained male HR 200, SV 110, Q̇ 22.0; untrained female HR 200, SV 90, Q̇ 18.0; trained male HR 190, SV 180, Q̇ 34.2; trained female HR 190, SV 125, Q̇ 23.8.](images/lec08/slide-030.png)
...
![Slide titled "Correlation between HR and VO2." Left: a scatter plot with heart rate (b/min, 40–180) on the x-axis and % VO2max (0–100%) on the y-axis. A linear regression line (y = 0.002x − 0.4496, R² = 0.9676) shows a strong positive correlation. Right: a photo of two runners with fitness watches. The linear relationship allows VO2 to be estimated from heart rate, which is the basis for fitness watch VO2max estimates.](images/lec08/slide-031.png)
...
![Slide titled "Correlation between HR and VO2." A scatter plot shows the relationship between heart rate (beats/min, 0–120) and rate of oxygen consumption (mL O2/g/h, 0–1.0) in Galápagos marine iguanas at two temperatures (27°C open symbols, 36°C filled symbols). Two regression lines with different slopes show a linear relationship at each temperature, but the slope and intercept differ between temperatures. Citation provided for the study.](images/lec08/slide-032.png)
...
![Slide titled "Redistribution of blood flow during exercise." Two graphs with % VO2max on the x-axis (25–100%). Top graph: muscle blood flow (mL) rises steeply and linearly from ~400 at rest to ~1500 at 100% VO2max. Bottom graph: splanchnic blood flow (mL) declines from ~100 at rest to near 20 at 100% VO2max. The graphs illustrate the dramatic shift of blood flow from visceral organs to working muscles during exercise.](images/lec08/slide-033.png)
...
![Flow chart titled "Summary of cardiovascular responses to exercise." Two main branches: CARDIAC OUTPUT (left) and BLOOD FLOW TO SKELETAL MUSCLES (right). Under cardiac output: heart rate (increased by sympatho-adrenal system) and stroke volume (increased by improved venous return, which is driven by skeletal muscle activity and deeper breathing). Under blood flow to muscles: metabolic vasodilation in muscles and sympathetic vasoconstriction in viscera. A box on the right shows "Frank-Starling mechanism" connecting skeletal muscle activity and deeper breathing to improved venous return and stroke volume.](images/lec08/slide-035.png)
...
![Slide with lavender background showing only the title "Questions?" — an open Q&A slide for student interaction.](images/lec08/slide-038.png)
...
![Summary slide titled "Cardiovascular responses to exercise" with overview and learning objectives identical to Slide 2: oxygen supply cascade from alveoli to mitochondria, cardiovascular response to exercise, comparative cardiorespiratory physiology, and seven learning objectives.](images/lec08/slide-039.png)
...
|----------|------|-------------|
| $\dot{V}O\_2 = \dot{Q}(C\_aO\_2 - C\_{\bar{v}}O\_2)$ | Fick principle (cardiovascular) | O<sub>2</sub> consumption from cardiac output and the arteriovenous O<sub>2</sub> content difference |
| $\dot{Q} = HR \times SV$ | Cardiac output | Cardiac output (L/min) equals heart rate (beats/min) times stroke volume (mL/beat) |
| $\%\text{Sat} = \frac{[O\_2]}{O\_2 \text{ capacity}} \times 100$ | Hemoglobin percent saturation | Fraction of hemoglobin binding sites occupied by O<sub>2</sub>; O<sub>2</sub> capacity ≈ 1.34 mL O<sub>2</sub>/g Hb |
...
| $fAS = \frac{\dot{V}O\_2\text{max}}{SMR}$ | Factorial aerobic scope | Ratio of maximum O<sub>2</sub> uptake to standard (or basal) metabolic rate; typically 5–10× in vertebrates |
...
| Term | Definition |
|------|-----------|
| **Oxygen-hemoglobin dissociation curve** | The sigmoid-shaped curve describing the relationship between P<sub>O₂</sub> and hemoglobin O<sub>2</sub> saturation; determines O<sub>2</sub> loading and unloading characteristics. |
| **Bohr effect** | Rightward shift of the O<sub>2</sub>-hemoglobin dissociation curve at lower pH (higher CO<sub>2</sub>); promotes O<sub>2</sub> unloading at metabolically active tissues. |
| **Temperature effect (on Hb curve)** | Rightward shift of the dissociation curve at higher temperature; exercising muscles generate heat locally, enhancing O<sub>2</sub> release precisely where demand is highest. |
| **Myoglobin (Mb)** | An O<sub>2</sub>-binding protein in muscle cells with higher O<sub>2</sub> affinity than hemoglobin; acts as an intramuscular O<sub>2</sub> shuttle from capillaries to mitochondria and as a short-term O<sub>2</sub> store at exercise onset. |
| **a-v O<sub>2</sub> difference** | The difference in O<sub>2</sub> content between arterial and mixed venous blood; reflects the amount of O<sub>2</sub> extracted by tissues per unit of blood. Widens from ~5 to ~16 mL O<sub>2</sub>/dL from rest to maximal exercise. |
...
| **Cardiac shunt** | Mixing of oxygenated and deoxygenated blood in animals with incompletely divided ventricles; reduces arterial O<sub>2</sub> saturation at rest but can be reduced during exercise to boost O<sub>2</sub> delivery. |
| **Graphical Fick solution** | Visualization of total O<sub>2</sub> delivery as a rectangle where width = cardiac output and height = a-v O<sub>2</sub> difference; area = VO<sub>2</sub>. |
...
| **Factorial aerobic scope (fAS)** | Ratio of VO<sub>2</sub>max to SMR (or BMR); typically 5–10× in vertebrates; animals with high fAS tend to have large hearts and high hemoglobin concentrations. |
...
| **Metabolic vasodilation** | Local dilation of arterioles in active muscles caused by accumulation of CO<sub>2</sub>, H<sup>+</sup>, adenosine, nitric oxide, and K<sup>+</sup>; overrides sympathetic vasoconstriction in working muscles. |
