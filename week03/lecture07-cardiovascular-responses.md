---
layout: lecture
title: "Lecture 7: Cardiovascular Responses to Exercise"
week: 3
lecture: 7
week_title: "Week 3: Control of Ventilation, Comparative Pulmonary Function, Cardiovascular Responses"
week_url: /week03/
total_slides: 39
prev_lecture: /week03/lecture06-ventilation-perfusion-comparative
next_lecture:
---

## Slide 1

![Title slide for "Cardiovascular responses to exercise" by Dr. Monica A. Daley, Professor, Ecology and Evolutionary Biology, University of California, Irvine. Background collage shows diverse animals and humans exercising: a cyclist, water polo ball, speed skater, sea turtle, horse, parrot, fish, and runners.](images/lec07/slide-001.png)
...
![Text slide titled "Cardiovascular responses to exercise" listing the overview (oxygen supply cascade from alveoli to mitochondria; cardiovascular response to exercise; comparative cardiorespiratory physiology) and seven learning objectives covering V/Q review, O2 transport mechanisms, factors limiting cardiovascular O2 transport, cardiac output increases, oxygen-dissociation curves, graphical Fick solution, and comparative cardiovascular function.](images/lec07/slide-002.png)
...
![Text slide titled "Cardiovascular responses to exercise" with overview and learning objectives identical to Slide 2: oxygen supply cascade from alveoli to mitochondria, cardiovascular response to exercise, comparative cardiorespiratory physiology, and seven learning objectives.](images/lec07/slide-006.png)
...
![Diagram of the complete cardiorespiratory circuit with partial pressures at each stage. Right side lists factors in gas transport with three items highlighted in blue: O2-hemoglobin curve, O2-myoglobin curve, and myoglobin store in muscle. These are the new topics for this portion of the lecture, added to the previously covered factors (alveolar ventilation, partial pressure gradients, diffusion conductance, ventilation-perfusion matching, shunts).](images/lec07/slide-007.png)
...
![Diagram of the cardiorespiratory circuit (same as Slide 7) with the factor "O2-hemoglobin curve" highlighted in blue on the right side. This identifies the specific topic being discussed next.](images/lec07/slide-008.png)
...
![Graph titled "Oxygen-Hemoglobin Dissociation Curve." X-axis: PO2 (mmHg) from 0 to 100. Left y-axis: percent oxyhemoglobin saturation (0–100%). Right y-axis: O2 content released (mL O2 per 100 mL blood, 0–20). The sigmoid curve is shown with annotations: "Arteries" at PO2 ≈ 100 mmHg (~100% saturation), "Veins (at rest)" at PO2 ≈ 40 mmHg (~75% saturation). A bracket labeled "Amount of O2 unloaded to tissues" spans the vertical drop between the arterial and venous saturation levels.](images/lec07/slide-011.png)
...
![Diagram of the cardiorespiratory circuit with partial pressures at each stage. Right side lists all factors in gas transport, with "O2-myoglobin curve" and "myoglobin store in muscle" highlighted in blue, indicating the next topic.](images/lec07/slide-014.png)
...
![Diagram of the cardiorespiratory circuit with partial pressures at each stage. Right side lists all factors in gas transport (alveolar ventilation, partial pressure gradients, diffusion conductance, ventilation-perfusion matching, shunts, O2-hemoglobin curve, O2-myoglobin curve, myoglobin store in muscle) — all now listed in standard black text, indicating all factors have been covered.](images/lec07/slide-016.png)
...
![Slide titled "Diversity & similitude in vertebrate cardiorespiratory systems" showing four vertebrate groups (fish, amphibian, reptile, mammal/bird) with circulatory diagrams. Fish: two-chambered heart, single circuit through gills. Amphibian: three-chambered heart with mixed blood in a shared ventricle. Reptile: partially divided ventricle with potential for shunting. Mammal/bird: fully divided four-chambered heart with separate pulmonary and systemic circuits.](images/lec07/slide-018.png)
...
![Slide titled "Diversity & similitude in vertebrate cardiorespiratory systems." Four panels of bar graphs (from Wang et al. 2019) comparing cardiovascular parameters across diverse species grouped by color: fish/amphibians, reptiles, birds, and mammals. The parameters appear to include heart rate, stroke volume, cardiac output, and factorial changes during exercise. The bottom-right panel shows the factorial change in heart rate between rest and exercise, with birds showing the largest increases.](images/lec07/slide-023.png)
...
![Section divider slide with lavender background showing the title "Cardiovascular responses to exercise" in large black text. This marks the transition to the specific cardiovascular adjustments during exercise.](images/lec07/slide-026.png)
...
![Slide titled "Transition from rest to steady exercise to recovery." Three stacked time-series graphs with exercise time (min) on the x-axis (0–20). Top graph: cardiac output (L/min) rises sharply at exercise onset from ~5 to ~15 L/min, maintains a plateau during steady-state exercise, then gradually returns to rest during recovery. Middle graph: stroke volume (mL) rises modestly from ~80 to ~120 mL at exercise onset, then plateaus. Bottom graph: heart rate (beats/min) rises sharply from ~70 to ~160 at exercise onset, then gradually returns to rest during recovery. The recovery rate of heart rate is noted as an indicator of fitness.](images/lec07/slide-027.png)
...
![Slide titled "Effects of training" with a table showing typical resting and maximal exercise values for stroke volume (SV), heart rate (HR), and cardiac output (Q̇). Rest: untrained male HR 72, SV 70, Q̇ 5.00; untrained female HR 75, SV 60, Q̇ 4.50; trained male HR 50, SV 100, Q̇ 5.00; trained female HR 55, SV 80, Q̇ 4.40. Max exercise: untrained male HR 200, SV 110, Q̇ 22.0; untrained female HR 200, SV 90, Q̇ 18.0; trained male HR 190, SV 180, Q̇ 34.2; trained female HR 190, SV 125, Q̇ 23.8.](images/lec07/slide-030.png)
...
![Slide titled "Correlation between HR and VO2." Left: a scatter plot with heart rate (b/min, 40–180) on the x-axis and % VO2max (0–100%) on the y-axis. A linear regression line (y = 0.002x − 0.4496, R² = 0.9676) shows a strong positive correlation. Right: a photo of two runners with fitness watches. The linear relationship allows VO2 to be estimated from heart rate, which is the basis for fitness watch VO2max estimates.](images/lec07/slide-031.png)
...
![Flow chart titled "Summary of cardiovascular responses to exercise." Two main branches: CARDIAC OUTPUT (left) and BLOOD FLOW TO SKELETAL MUSCLES (right). Under cardiac output: heart rate (increased by sympatho-adrenal system) and stroke volume (increased by improved venous return, which is driven by skeletal muscle activity and deeper breathing). Under blood flow to muscles: metabolic vasodilation in muscles and sympathetic vasoconstriction in viscera. A box on the right shows "Frank-Starling mechanism" connecting skeletal muscle activity and deeper breathing to improved venous return and stroke volume.](images/lec07/slide-035.png)
...
![Slide with lavender background showing only the title "Questions?" — an open Q&A slide for student interaction.](images/lec07/slide-038.png)
