...
![Slide titled "Ventilation/perfusion ratio V̇A/Q̇ rest vs. exercise." Four panels show V/Q distributions for human athletes, horses, varanid lizards, and emus. Rest (open circles) and exercise (closed circles) are compared. V/Q heterogeneity increases in all species except birds during exercise. The emu distribution centers around 1.0 during exercise (perfect matching).](images/lec07/slide-006.png)
...
![A research article page titled "Respiratory evolution in archosaurs" (Brocklehurst et al. 2020). A cladogram of Archosauromorpha shows evolutionary relationships with major innovations in respiratory system evolution mapped onto branches. Text notes: "Many dinosaurs had air sacs & relatively rigid lungs, like birds." Extant taxa in black, extinct in grey.](images/lec07/slide-008.png)
...
![Slide titled "Did bird-like lungs allow dinosaurs to dominate?" with an NPR article about Emma Schachner's research on dinosaur lungs and a screenshot of a YouTube video titled "Sauropods: Air Hulks" discussing respiratory adaptations in large dinosaurs.](images/lec07/slide-009.png)
...
![Text slide titled "Cardiovascular responses to exercise" with overview and learning objectives identical to Slide 2: oxygen supply cascade from alveoli to mitochondria, cardiovascular response to exercise, comparative cardiorespiratory physiology, and seven learning objectives.](images/lec07/slide-010.png)
...
![Diagram of the complete cardiorespiratory circuit with partial pressures at each stage. Right side lists factors in gas transport with three items highlighted in blue: O2-hemoglobin curve, O2-myoglobin curve, and myoglobin store in muscle. These are the new topics for this portion of the lecture, added to the previously covered factors (alveolar ventilation, partial pressure gradients, diffusion conductance, ventilation-perfusion matching, shunts).](images/lec07/slide-011.png)
...
![Diagram of the cardiorespiratory circuit (same as Slide 11) with the factor "O2-hemoglobin curve" highlighted in blue on the right side. This identifies the specific topic being discussed next.](images/lec07/slide-012.png)
...
![Graph titled "Oxygen-Hemoglobin Dissociation Curve." X-axis: PO2 (mmHg) from 0 to 100. Left y-axis: percent oxyhemoglobin saturation (0–100%). Right y-axis: O2 content released (mL O2 per 100 mL blood, 0–20). The sigmoid curve is shown with annotations: "Arteries" at PO2 ≈ 100 mmHg (~100% saturation), "Veins (at rest)" at PO2 ≈ 40 mmHg (~75% saturation). A bracket labeled "Amount of O2 unloaded to tissues" spans the vertical drop between the arterial and venous saturation levels.](images/lec07/slide-015.png)
...
![Diagram of the cardiorespiratory circuit with partial pressures at each stage. Right side lists all factors in gas transport, with "O2-myoglobin curve" and "myoglobin store in muscle" highlighted in blue, indicating the next topic.](images/lec07/slide-018.png)
...
![Diagram of the cardiorespiratory circuit with partial pressures at each stage. Right side lists all factors in gas transport (alveolar ventilation, partial pressure gradients, diffusion conductance, ventilation-perfusion matching, shunts, O2-hemoglobin curve, O2-myoglobin curve, myoglobin store in muscle) — all now listed in standard black text, indicating all factors have been covered.](images/lec07/slide-020.png)
...
![Slide titled "Diversity & similitude in vertebrate cardiorespiratory systems" showing four vertebrate groups (fish, amphibian, reptile, mammal/bird) with circulatory diagrams. Fish: two-chambered heart, single circuit through gills. Amphibian: three-chambered heart with mixed blood in a shared ventricle. Reptile: partially divided ventricle with potential for shunting. Mammal/bird: fully divided four-chambered heart with separate pulmonary and systemic circuits.](images/lec07/slide-022.png)
...
![Slide titled "Graphical solution to the Fick principle for oxygen uptake." Same format as Slide 24, but showing a fish silhouette. The dissociation curve shows SMR (standard metabolic rate) and Exercise rectangles. The label uses "SMR" instead of "BMR" because ectotherms have a standard metabolic rate measured at a controlled temperature. Citation: Wang et al. 2019.](images/lec07/slide-025.png)
...
![Slide titled "Diversity & similitude in vertebrate cardiorespiratory systems." Four panels of bar graphs (from Wang et al. 2019) comparing cardiovascular parameters across diverse species grouped by color: fish/amphibians, reptiles, birds, and mammals. The parameters appear to include heart rate, stroke volume, cardiac output, and factorial changes during exercise. The bottom-right panel shows the factorial change in heart rate between rest and exercise, with birds showing the largest increases.](images/lec07/slide-027.png)
...
![Section divider slide with lavender background showing the title "Cardiovascular responses to exercise" in large black text. This marks the transition to the specific cardiovascular adjustments during exercise.](images/lec07/slide-030.png)
...
![Slide titled "Effects of training" with a table showing typical resting and maximal exercise values for stroke volume (SV), heart rate (HR), and cardiac output (Q̇). Rest: untrained male HR 72, SV 70, Q̇ 5.00; untrained female HR 75, SV 60, Q̇ 4.50; trained male HR 50, SV 100, Q̇ 5.00; trained female HR 55, SV 80, Q̇ 4.40. Max exercise: untrained male HR 200, SV 110, Q̇ 22.0; untrained female HR 200, SV 90, Q̇ 18.0; trained male HR 190, SV 180, Q̇ 34.2; trained female HR 190, SV 125, Q̇ 23.8.](images/lec07/slide-034.png)
...
![Slide titled "Correlation between HR and VO2." Left: a scatter plot with heart rate (b/min, 40–180) on the x-axis and % VO2max (0–100%) on the y-axis. A linear regression line (y = 0.002x − 0.4496, R² = 0.9676) shows a strong positive correlation. Right: a photo of two runners with fitness watches. The linear relationship allows VO2 to be estimated from heart rate, which is the basis for fitness watch VO2max estimates.](images/lec07/slide-035.png)
...
![Slide with lavender background showing only the title "Questions?" — an open Q&A slide for student interaction.](images/lec07/slide-042.png)
