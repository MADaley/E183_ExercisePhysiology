---
layout: lecture
title: "Lecture 21: Exercise as Medicine"
week: "9-10"
lecture: 21
week_title: "Weeks 9–10: Integrative Topics in Exercise Physiology"
week_url: /week09-10/
total_slides: 33
...
![Title slide for E183 Exercise Physiology showing the subtitle "Exercise as medicine (a very brief intro)" by Professor Monica A. Daley, Ecology and Evolutionary Biology, University of California, Irvine. Background collage features photos of diverse animals and a human runner.](images/lec21/slide-001.png)
...
- VO<sub>2</sub> max declines with age in all adults, but the rate of decline differs substantially between active and sedentary populations.
...
- A sedentary adult who begins an exercise program can achieve a meaningful immediate increase in VO<sub>2</sub> max, shifting closer to the active-adult trajectory.
...
- This landmark study followed over 4,000 healthy adults for an average of 24 years, categorized by cardiorespiratory fitness level (low, moderate, or high) based on VO<sub>2</sub> max percentiles.
...
![Bar chart titled "Endurance exercise protects against cardiac injury." Y-axis shows percentage of cardiac injury during a myocardial infarction (0–100%). Untrained individuals show approximately 60% cardiac injury. Trained individuals show approximately 20% cardiac injury.](images/lec21/slide-007.png)
...
![Screenshot of a New York Times article by Gretchen Reynolds titled "How Exercise Enhances Aging Brains." Subheading: "Sedentary, older adults who took aerobic dance classes twice a week showed improvements in brain areas critical for memory and thinking." Photo shows a group of adults participating in an aerobic dance class in a large room. Caption: "Volunteers who participated in pre-pandemic dance classes in Newark, N.J., showed improvements in memory centers in the brain. Rutgers University."](images/lec21/slide-015.png)
...
- Basso and Suzuki proposed standardized categories for studying acute exercise effects: duration (short, moderate, long), intensity (low, moderate, high as a percentage of VO<sub>2</sub> max), perceived exertion (Borg scale), and a combined exercise index.
...
![Slide titled "Positive effects of acute exercise" showing the same review by Basso and Suzuki with a video thumbnail. Three summary bullet points: enhanced prefrontal cognitive function; enhanced positive mood and decreased negative mood; neurophysiological and neurochemical changes in hippocampus, prefrontal cortex, and other brain regions.](images/lec21/slide-018.png)
...
![Slide with purple background reading "Notecard: self-reflection — Do you get enough exercise?"](images/lec21/slide-019.png)
...
![Line graph titled "Percentage of U.S. adults who meet the guidelines" showing data from 2008 to 2016. Men (orange dashed line) increase from approximately 22% to 27%. Women (green solid line) increase from approximately 15% to 20%. Both trends show a slight upward trajectory but remain below 30%.](images/lec21/slide-021.png)
...
![Slide titled "Risks of sedentary behavior" defining it as any waking behavior with a low level of energy expenditure, including sitting, reclining, or lying down. More time in sedentary behavior increases risks of: all-cause mortality, cardiovascular disease mortality, cardiovascular disease, type 2 diabetes, cancer of the colon, endometrium and lung, high blood pressure, depression, immune dysfunction, and risk of fractures.](images/lec21/slide-022.png)
...
### Genetics Influence the Effects of Training on VO<sub>2</sub> Max
...
- The trainability of VO<sub>2</sub> max has a strong genetic component. Different genotypes show dramatically different responses to the same endurance training program.
...
- Chronic exposure to air pollution degrades cardiorespiratory function: decreased oxygen transport capacity, decreased VO<sub>2</sub> max, increased airway resistance, elevated blood pressure, and increased inflammatory markers.
...
![Slide titled "Social justice issues with 'Exercise as Medicine'" showing a screenshot of a KPBS news interview with Dr. Cheryl Anderson, Director of the UC San Diego Center for Excellence in Health Promotion and Equity. The topic is historical redlining and its contribution to health disparities.](images/lec21/slide-028.png)
...
![Screenshot of the "Redlining and Neighborhood Health" data visualization website showing an interactive map with color-coded neighborhoods overlaid with redlining zones and social vulnerability scores. Content warning noted regarding historically offensive language in the original documents.](images/lec21/slide-029.png)
...
![Screenshot showing redlining data visualization with text noting that historically "red-lined" districts have higher pollution and limited access to activity-friendly infrastructure such as green spaces, parks, and paths for bikes and pedestrians. High pollution leads to lower lung capacity, increased risk of asthma, pulmonary infection, and other chronic diseases.](images/lec21/slide-031.png)
...
![Slide identical to Slide 2, titled "Exercise as Medicine" showing the six learning objectives: (1) Relate fitness, training, and detraining to exercise as medicine; (2) Discuss evidence that exercise reduces mortality risk; (3) Describe the dose-response relationship; (4) List brain and mental health benefits; (5) Discuss interaction between sitting time and exercise benefits; (6) Consider environmental and social equity factors.](images/lec21/slide-033.png)
...
| Term | Definition |
|------|-----------|
| Cardiorespiratory fitness | The ability to perform large-muscle, whole-body exercise at moderate-to-vigorous intensities for extended periods; primarily measured by VO<sub>2</sub> max |
...
| MET (metabolic equivalent of task) | A unit expressing the energy cost of physical activity relative to rest; 1 MET equals resting metabolic rate (~3.5 mL O<sub>2</sub>·kg⁻¹·min⁻¹) |
