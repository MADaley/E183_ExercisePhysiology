---
layout: lecture
title: "Lecture 18: Putting Human Locomotion into a Comparative Context"
week: 8
lecture: 18
week_title: "Week 8: Energy Cost of Locomotion and Humans in Comparative Context"
week_url: /week08/
total_slides: 41
prev_lecture: /week08/lecture17-energy-cost
next_lecture:
---
...
![Slide titled "Interpreting cost of transport curves" repeating the previous figure with two changes: the walking curve (open circles) is now extended forward as a smooth purple extrapolation continuing the U-shape upward past the original data, rising to ~0.45 at 2.25 m/s; and a purple vertical dotted line is drawn at 2.25 m/s — the new candidate intersection of the extrapolated walking curve with the running curve. Bottom annotation: "The correct answer is 2.25 m/s."](images/lec18/slide-003.png)
...
![Slide titled "Interpreting cost of transport curves" with prompt "At what speed would you expect the ostrich to move if the main goal was the minimize the energetic cost to travel a given distance?" Same ostrich CoT-vs-speed plot as Slide 4 (walking blue, running orange), but now with a vertical red double-headed arrow drawn at the very lowest measured walking speed (~0.8 m/s) where the CoT data minimum is approximately 1.3 J/kg·m.](images/lec18/slide-005.png)
...
![Slide titled "Putting human locomotion into a comparative context" with the overview "Thinking about humans in an evolutionary context" followed by learning objectives: 1) Discuss adaptive features for athletic movement among vertebrates (speed, economy and endurance); 2) Discuss and critically evaluate evidence for the idea that humans are running specialists.](images/lec18/slide-008.png)
...
![Transition slide with the text "What features of morphology and physiology reflect adaptation for endurance locomotion?" centered in a large italicized question.](images/lec18/slide-010.png)
...
![Slide titled "Quadrupedal mammals: Ungulates" with four photographs of cursorial ungulates in a row: pronghorn antelope (small, alert in grass), zebra (mid-size, photographed in a herd), elephant (large, standing in sand), and racehorse (slim and powerful, photographed mid-stride with a jockey). Bullet list: Antelope, deer, camel, horse, zebra, elephant; Specialists in endurance and speed (in green); Swift grazing animals; Many migrate long distance; Many are prey animals.](images/lec18/slide-011.png)
...
![Slide titled "Bipedal vertebrates: Theropod dinosaurs and birds" with a collage of bipedal vertebrates — top row: an artistic reconstruction of a Velociraptor-style theropod dinosaur (Luis Rey 2002) and a great egret (Ardea alba) in flight; second row: a turkey and an ostrich (in mid-stride, against a desert backdrop); third row: a guinea fowl and a small quail (bobwhite).](images/lec18/slide-012.png)
...
![Small standalone slide titled "Morphological adaptations for economy and speed" with a photograph of two large mammal skeletons (likely an elephant and a smaller mammal) in a museum display, overlaid with a centered question in white text on dark background: "Is large body size itself an adaptation for athletic performance?"](images/lec18/slide-018.png)
...
![Slide same overview slide as Slide 22 minus the bullet list — three athletic-vertebrate photographs (ostrich, pronghorn, racehorse) above a centered question "What about physiological adaptations for athletic performance?"](images/lec18/slide-023.png)
...
![Slide titled "Putting human locomotion into a comparative context" with the same overview "Thinking about humans in an evolutionary context" and the two learning objectives from Slide 8: 1) Discuss adaptive features for athletic movement among vertebrates (speed, economy and endurance); 2) Discuss and critically evaluate evidence for the idea that humans are running specialists.](images/lec18/slide-041.png)
...
| **Pontzer's economy and endurance studies** | A series of comparative studies showing that humans have dramatically greater endurance than chimpanzees, our VO<sub>2max</sub> follows the standard mammalian muscle-mass scaling line, and our walking is exceptionally economical relative to other primates. |
