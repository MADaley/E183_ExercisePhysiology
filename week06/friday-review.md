---
layout: lecture
title: "Week 6 Friday Review and Discussion"
week: 6
lecture: "Friday Review"
week_title: "Week 6: Integrative Muscle Structure and Function"
week_url: /week06/
total_slides: 19
prev_lecture: /week06/lecture14-muscle-whole-organism
next_lecture:
---

This Friday session completes the Week 6 integrative muscle material and then moves into a structured **practice-question** segment. The first half consolidates the **proximo-distal distribution** of muscle mass and architecture in the limb; the **inverse-dynamics** vs **direct measurement** distinction; the **muscle work loop** as the unifying analytical tool for *in vivo* muscle function; and a **case-study tour** spanning turkey, wallaby, guinea fowl, and cockatiel that places each muscle on a **motor ↔ spring** spectrum. It then moves to **human applications** — *in vivo* ultrasound of the soleus during walking and running, the gait-transition shift, and prosthetic and exoskeleton design. The second half is a set of three **quantitative practice questions** comparing cheetah and greyhound gastrocnemius architecture, calculating quadriceps force in a static squat, and sketching three idealized work-loop shapes. A closing **announcement** introduces the **Dr. M. Marlene Godoy Fellowship** in Movement Sciences for summer 2026 undergraduate research.
...
- **Key methodological point**: this is the only way to **separate fascicle behavior from tendon behavior** in humans. The MTU length comes from joint kinematics; the fascicle length comes from ultrasound; the **tendon length is the difference** — and the difference is what reveals elastic energy storage in the Achilles.
...
- **Key finding**: across cursorial animals and humans, the **majority of MTU length change during loading is taken up by the tendon**, not the fascicle. This is the **strut-and-spring mechanism** confirmed in the human gastrocnemius.
- **Speed dependence**: as gait speed rises within walking or within running, the **fascicle shortening increases** modestly — the muscle does more **active work** at higher speeds, while the tendon continues to do most of the elastic energy cycling.
...
- **Take-home (caption)**: the **gait transition** is partly a strategy to keep the soleus operating **near optimal length** and at **slow shortening velocity** — both more favorable for **power production** and for **economy** than walking quickly would be.
...
- **Key finding**: there is **no clear optimal stiffness** across athletes — the within-blade variation is large, and the across-blade differences are modest. Different runners do best with **different blade-stiffness combinations**.
...
- **Take-home (red caption)**: "Effective tuning of stiffness is essential for maintaining economical muscle-tendon dynamics when using assistive devices."
- **Design implication**: a passive spring is not "free" energy — it changes the **operating point** of the muscle on its **intrinsic F–L and F–V curves**. Optimal device design requires understanding the **biological muscle's mechanical properties** as well as the device.

---

## Slide 14

![Slide titled "Summary:" with five bullet points in dark blue text on a white background. Bullet 1: Trade-offs exist between force and displacement at the level of tissue (F-L, F-V), organ (muscle-tendon architecture), and limb (joint lever systems). Bullet 2: Muscle-tendon architecture influences muscle mechanical function and versatility (with "mechanical function" and "versatility" underlined). Bullet 3: A proximo-distal distribution exists in muscle-tendon architecture. Bullet 4: Muscle-tendon architecture relates to mechanical roles in locomotion: power production for acceleration, elastic energy cycling for economical gait. Bullet 5: Understanding principles of muscle tendon function can inform design of rehabilitation and mobility assistance devices.](images/friday-review/slide-014.png)
...
![Slide containing only the heading "Practice questions" centered on a white background in large blue text.](images/friday-review/slide-015.png)
...
- **Reasoning framework** (revisit Lecture 13 architecture relationships):
  ...
  - **Maximum shortening velocity ∝ fiber length** (number of sarcomeres in series) → cheetah gastroc has **higher V<sub>max</sub>** at the muscle level.
...
![Slide titled "Practice question: A paper compared muscle morphology between the cheetah and the greyhound. The collected the data below on the gastrocnemius of each animal." Same heading and citation as Slide 16. Updated data table now includes a fourth column "PCSA (cm²)" — Cheetah 32, Greyhound 53.3. The other columns (moment arm, FL, volume) are unchanged. Below the table: "Assuming that both animals have a ground reaction force lever arm = 5 cm, calculate the maximum ground reaction force, F_g, that each muscle can resist, assuming a specific tension of 25 N/cm²."](images/friday-review/slide-017.png)
...
- **Setup**: both animals have a **ground reaction force lever arm = R = 5 cm** about the ankle (i.e., the distance from the GRF vector to the ankle joint center). Specific tension = **25 N/cm²**. Find the **maximum GRF (F<sub>g</sub>) that the muscle can resist**.
...
$$F_m \cdot r_m = F_g \cdot R$$

  $$F_g = F_m \cdot \frac{r_m}{R}$$
...
$$F_{\text{quads}} \cdot r_q = F_g \cdot R$$

$$F_{\text{quads}} = F_g \cdot \frac{R}{r_q}$$

- **Solve**:
  - **Standing**: $F_{\text{quads}} = 319 \times \frac{1}{3} \approx 106$ N
  - **Squat**: $F_{\text{quads}} = 319 \times \frac{10}{3} \approx 1063$ N
- **Comparison**: the quadriceps must produce **~10× more force** in the static squat than standing — purely because of the **change in moment-arm ratio**. The body weight has not changed at all.
- **Why this matters**:
...
| **Specific tension ($\sigma\_{\text{spec}}$)** | Maximum isometric force per unit cross-sectional area of muscle, ~20–30 N/cm² (often 25 N/cm² as in the practice problem). Sets the conversion from PCSA to maximum muscle force. |
