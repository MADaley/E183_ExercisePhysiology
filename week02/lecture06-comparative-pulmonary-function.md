---
layout: lecture
title: "Lecture 6: Comparative Pulmonary Function"
week: 2
lecture: 6
...
next_lecture: /week03/lecture07-ventilation-perfusion-matching
---

## Slide 1

![Title slide for "Comparative pulmonary function" by Dr. Monica A. Daley, Professor, Ecology and Evolutionary Biology, University of California, Irvine. Background collage shows diverse animals and humans exercising.](images/lec06/slide-001.png)
...
- At high work rates, arterial O<sub>2</sub> saturation drops below 95% in normoxia; supplemental O<sub>2</sub> ameliorates the effect, indicating a pulmonary limitation on O<sub>2</sub> uptake.
...
![Text slide titled "Comparative pulmonary function" listing the overview ("Comparative case studies on cardiorespiratory physiology") and a single learning objective: "Discuss the diversity of lung structure present among vertebrates and its relationship with endurance exercise capacity."](images/lec06/slide-006.png)
...
![Slide titled "Avian respiratory system." Left: a silhouette of a bird with the respiratory system illustrated, showing the lung in the center connected to anterior air sacs (cervical, clavicular, cranial thoracic) and posterior air sacs (caudal thoracic, abdominal). Right: an anatomical diagram of the avian lung showing the trachea, primary bronchus, inter-pulmonary bronchus, ventral bronchi, dorso-bronchi, parabronchi, and anterior and posterior air sacs.](images/lec06/slide-009.png)
...
![Slide titled "Avian respiratory system" showing two side-by-side diagrams of a bird in lateral view. Left panel: inhalation — arrows show air entering the trachea and flowing to the posterior air sacs; some air passes through the lung. Right panel: exhalation — arrows show the posterior air sacs compressing and pushing air through the rigid lung (parabronchi), then into the anterior air sacs, and out. Labels identify the lung, trachea, posterior air sacs, and anterior air sacs.](images/lec06/slide-011.png)
...
![Phylogenetic tree titled "Unidirectional airflow may be a factor in the diversity of athletic animals in the archosaur lineage" — same image as Slide 12. Major vertebrate groups from fish to mammals are shown, with archosaurs (crocodilians and birds) highlighted with red markers. Photos on the right show a bird of prey, a running ostrich, a galloping crocodile, and a running cheetah. Text labels note "Athletic animals, high aerobic scope, endurance."](images/lec06/slide-021.png)
...
- These respiratory adaptations are associated with **aerobic scope** (the ratio of VO<sub>2</sub>max to basal metabolic rate) and endurance capacity.
...
![Summary slide identical to Slide 6, titled "Comparative pulmonary function." Lists the overview ("Comparative case studies on cardiorespiratory physiology") and the single learning objective: "Discuss the diversity of lung structure present among vertebrates and its relationship with endurance exercise capacity."](images/lec06/slide-022.png)
...
| **Blood-gas barrier** | The thin tissue separating air in the gas-exchange surface from blood in the pulmonary capillaries; thinner barriers (as in avian parabronchi) allow more efficient O<sub>2</sub> diffusion. |
